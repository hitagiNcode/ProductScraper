...
{
    public partial class ProductScrapeFirstMigration : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PictureUri = table.Column<string>(type: "nvarchar(1500)", maxLength: 1500, nullable: true),
                    ...
                    FollowingUsers = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
